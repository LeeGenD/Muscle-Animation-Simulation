(function(){
	...
	function init() {
		...
		loader.load( "./javascripts/hand_skeletal.js", function ( geometry, materials ) { createScene( geometry, materials, 0, FLOOR, 0, 60 ) } );
		loader.load( "./javascripts/hand_muscular.js", function ( geometry, materials ) { createScene( geometry, materials, 0, FLOOR, 0, 60 , addController) } );
