(function(){
	...
	function init() {
		...
		scene.fog = new THREE.Fog( 0xeeeeee, 2000, 10000 );
		...
		//wholeman_onlyBody
		loader.load( "./javascripts/chest_skeletal.js", function ( geometry, materials ) { createScene( geometry, materials, 0, FLOOR, 0, 60 ) } );
		loader.load( "./javascripts/chest_muscular.js", function ( geometry, materials ) { createScene( geometry, materials, 0, FLOOR, 0, 60 , addController) } );
