(function(){
	...
	function init() {
		...
		//wholeman_onlyBody
		loader.load( "./javascripts/foot_skeletal.js", function ( geometry, materials ) { createScene( geometry, materials, 0, FLOOR, 0, 60 ) } );
		loader.load( "./javascripts/foot_muscular.js", function ( geometry, materials ) { createScene( geometry, materials, 0, FLOOR, 0, 60 , addController) } );
